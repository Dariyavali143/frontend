...
setTimeout(ClearLocalData,1800000);
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <button class="btn btn-outline-success" type="submit" data-bs-toggle="modal" data-bs-target="#staticBackdrop_1">Contact</button>
                <button class="btn btn-outline-success" type="submit" onClick={GoToRegisterPage}>Want a Job</button>
                    ...
                    getdbdata1.map((ele, index) => {
                      ...
                      return (
                        ...
                        <div className="col-lg-12 job-details" key={index}>
                          ...
                          <button type="button" class="btn btn-primary" style={{ width: '90%', fontWeight: 'bold', opacity: '0.7', marginBottom: '10px', marginTop: '10px', borderRadius: '15px' }} onClick={LogOut}>LogOut </button>
        ...
        <div class="offcanvas-body">
          ...
          <div className='NavBar2'>
            ...
            <div className='sidebar'>
              ...
              <button class="btn btn-primary" style={{ width: '100%', fontWeight: 'bold' }} onClick={GoToRegisterPage}>Want a Job</button>
              <button class="btn btn-warning" style={{ width: '100%', fontWeight: 'bold' }} onClick={LogOut}>LogOut</button>
