        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="d-flex">
              ...
              <Link to ='/PostJob'><button class="btn btn-outline-success" type="submit" onClick={()=>(alert("Plase Login"))}>Post a Job</button></Link>
              <Link to="/Home3"> <button class="btn btn-outline-success" type="submit" style={{ fontWeight: 'bold', color: 'blue' }}>Home</button></Link>
            </div>
          </div>
        </div>
      </nav>
        ...
        <div class="offcanvas-body">
          ...
          <div className='NavBar2'>
           ...
           <span class="SideBarLinks" data-bs-toggle="modal" data-bs-target="#staticBackdrop_2">Post a Job</span>
               <Link to='/Home3'><span class="SideBarLinks">Home</span></Link> 
